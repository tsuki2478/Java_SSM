...
<ul id="myTab" class="nav nav-tabs">
	<li class="active">
		<a href="#addhandle" data-toggle="tab">
			 新增处理
		</a>
	</li>
	<li><a href="#adddesc" data-toggle="tab">
		   添加描述
		</a></li>
...
<div id="myTabContent" class="tab-content">
                    ...
                    <option value="0">--请选择处理人--</option>
							...
							<tr>
								<td>
								  ...
								  <input type="radio" name="status" value="3" >退单
  ...
  <c:otherwise>
	...
	<a class="pull-left" href="#">
		<img class="media-object" src="assets/img/face.jpg" style="width: 100px; height: 100px;" alt="媒体对象">
	</a>
	<div class="media-body">
		<span> 处理组：${h.handlegroupname }
		 处理人：${h.handlepersonname } </span><br/>
		<span>操作:${h.actionstr }</span>
		<span> 操作时间：
		   <fmt:formatDate value="${h.createdate }" pattern="yyyy-MM-dd HH:mm:ss"/>
		 </span><Br/>
		<span> 处理意见：${empty h.descs ?'无':h.descs } </span>
	</div>
</div>
</c:forEach>
    </div>
